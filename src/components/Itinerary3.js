...
export default function Itinerary3() {
  return (
    <>
    <div className="itinerary_image3">
        <div id='name'>Tosh</div>
        <div id='itinerary_date'>1 June - 4 June</div>
        <div id='itinerary_route'>Chandigarh to Chandigarh</div>
          <div id="book_button">
            <Link to="/toshform"><button className='btn-sm' id='booknow_button'>Book Now</button></Link>
        </div>
        <span id='itinerary_highlights'>Far end of Parvati Valley</span>
      </div>

      {/* Cards Section */}
      <div className="itinerary_lower3">
      <div className="row justify-content-evenly">
        ...
        <div className='text-center mt-4'>
          <a href="https://drive.google.com/file/d/1UT_kTO1xAsxnEA6-OfiknVmkuLJcaP85/view?usp=sharing" target='_blank' rel="noopener noreferrer">
